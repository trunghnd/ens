...
body { margin: 20px; }
    ...
    *{
    ...
    .quote-wrapper-table td.yellow{
        background-color:#e1e34d ;
    }
    .quote-wrapper-table tr.green,
    .quote-wrapper-table td.green{
        background-color:#74be4b ;
    }
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" class="header-table">
                <tr>
                    <td>
                        <img src="images/logo-quote.jpg" width="200" height="96" />
                    </td>
        ...
        <td>
            <table cellpadding="0" cellspacing="0" class="quote-details-table">
                <tr>
                    <!-- only on WKH Quote (???)-->
                    <td>
                        <h2 class="no-margin">Warmer Kiwi Homes</h2>
                    </td>
                    <!-- end only on WKH Quote (???)-->
        ...
        <td>
            <table cellpadding="0" cellspacing="0" class="installation-details-table">
                ...
                <tr>
                    ...
                    <td class="field"> {{$owner_telephone}}(Home/Work)</td>
                    <td class="label">Mobile</td>
                    <td class="field">{{$owner_mobile_phone}}</td>
                </tr>



@if ($ownership_status != "Owner Occupier")


                <tr>
                    <td class="label">Tenant Name</td>
                    <td class="field wide-field" colspan="3">{{$occupier_name}}</td>
                </tr>
                <tr>
                    <td class="label">Tenant Phone</td>
                    <td class="field"> {{$occupier_phone}} (Home/Work)</td>
                    <td class="label">Mobile</td>
...
?>
                ...
                <tr class="totals">
                    <td class="label" colspan="3">Total Quote Price</td>
                    <td class="unit-field money">${{$totals_total}}</td>
                    <td class="unit-field money">${{$totals_discount}}</td>
                    <td class="unit-field money">${{$totals_to_pay}}</td>
                </tr>
                <tr class="totals">
                    <td class="label" colspan="5">EECA Contribution</td>
                    <td class="unit-field money">$X.xx</td>
                </tr>
                <tr class="totals">
                    <td class="label" colspan="5">Third Pary Funding</td>
                    <td class="unit-field money">$X.xx</td>
                </tr>
                <tr class="totals">
                    <td class="label" colspan="5">Owners Contribution</td>
                    <td class="unit-field money">$X.xx</td>
                </tr>
                <tr class="summary">
                    <td colspan="2" rowspan="3" class="notes-box">Quote Notes:<p>{{$quote_notes}}</p></td>
                    <td colspan="3" class="money deposit-required"><strong>Deposit Required</td>
                    <td class="money deposit-required">${{$deposit_required}}</td>
                </tr>
                <tr class="summary">
                    <td colspan="3" class="money"><strong>Final Payment</strong><br><small>Required within 7 days of installation</small></td>
                    <td class="money">${{$balance_remaining}}</td>
                </tr>
                <tr class="summary">
                    <td colspan="4" class="yellow notes-box">
                        <p><strong>Payment &amp; Finance</strong><br>
                        To accept this quote, it must be signed and dated. Alternatively your deposit shall be deemed your full acceptance of the quote.</p>
                        <ul class="unordered-list">
                            <li>Internet Banking: ANZ 06 0821 0259765 05 and reference &ldquo;{{$quote_number}}&rdquo;.</li>
    ...
    <tr>
        <td class="green">
            <div class="actions-required-wrapper" style="page-break-inside: avoid;">
                ...
                <p><strong>The following actions are the responsibility of the home owner and must be completed prior to installation:</strong></p>
...
?>
    ...
    <tr class="grey">
        <td>
            <div class="authorisation-wrapper" style="page-break-inside: avoid;">
